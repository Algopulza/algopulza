  ...
  return (
    <Container>
      <Select>
        ...
        <CategoryButton onClick={showTag} color={tag?"white":"black"} bg={tag?"#FFC94D":"white"} hbg={tag?"#FFCF62":"#F4F4F4"} hc={tag?"white":"black"}>유형별 해결 문제 개수</CategoryButton>
        ...
        <CategoryButton onClick={showMonth} color={month?"white":"black"} bg={month?"#FFC94D":"white"} hbg={month?"#FFCF62":"#F4F4F4"} hc={month?"white":"black"}>월별 문제 풀이 개수</CategoryButton>
